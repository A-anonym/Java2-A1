...
//        });
    ...
    public List<String> getCourses(int topK, String by) {
        ...
        list=stream.sorted(comparator).map(Course::getTitle).distinct().limit(topK).collect(Collectors.toList());
//        for (String str : list) {
...
//        }
    ...
    public List<String> recommendCourses(int age, int gender, int isBachelorOrHigher) {
        ...
        Stream<Course> stream=courses.stream();
        Map<String, List<Course>> groupedByid = stream.collect(Collectors.groupingBy(Course::getNumber));
...
//            double similarity=Math.pow((age-doublelist.get(0)),2)+Math.pow((gender*100-doublelist.get(1)),2)+Math.pow((isBachelorOrHigher*100-doublelist.get(2)),2);
            double similarity=(age-doublelist.get(0))*(age-doublelist.get(0))+(gender*100-doublelist.get(1))*(gender*100-doublelist.get(1))+(isBachelorOrHigher*100-doublelist.get(2))*(isBachelorOrHigher*100-doublelist.get(2));
